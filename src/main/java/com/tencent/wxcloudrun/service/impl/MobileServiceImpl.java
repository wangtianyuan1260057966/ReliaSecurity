...
public class MobileServiceImpl implements MobileService {
    ...
    private String getDownLoadUrl(String url, String dept) {
        ...
        req.put("env", "prod-0gpbo5v390e650c8"); // 云开发环境 从小程序-云开发面板里面找到
        JSONArray array = new JSONArray();
        JSONObject file = new JSONObject();
        if (dept.isEmpty()) {
            file.put("fileid", "cloud://prod-0gpbo5v390e650c8.7072-prod-0gpbo5v390e650c8-1326313760/note/note.doc");
        } else {
            file.put("fileid", "cloud://prod-0gpbo5v390e650c8.7072-prod-0gpbo5v390e650c8-1326313760/note/" + dept + "/note.doc");
        }
    ...
    private String setFile(String fileUrl,String deptName, String dept, String otherNote, String access_token) {
        ...
        try {
            ...
            if (urlConn.getResponseCode() == HttpURLConnection.HTTP_OK) {
                ...
                httpPost.addHeader(HTTP.CONTENT_TYPE, "application/json");
                JSONObject req = new JSONObject();
                req.put("env", "prod-0gpbo5v390e650c8");
